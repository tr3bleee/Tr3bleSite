      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5 md:gap-3">
            <div
              className="p-2 md:p-2.5 rounded-2xl bg-neutral-100/80 dark:bg-neutral-800/50 group-hover:bg-neutral-200/80 dark:group-hover:bg-neutral-700/60 transition-colors duration-300"
              aria-hidden="true"
            >
              <Icon className="text-neutral-600 dark:text-neutral-300 text-[18px] md:text-[20px] transition-transform group-hover:scale-110" />
            </div>
            <span
              className="font-raleway font-semibold text-neutral-700 dark:text-neutral-200 leading-tight text-sm md:text-base"
              itemProp="name"
            >
              {name}
            </span>
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between">
        ...
        <div
          className="text-neutral-400 dark:text-neutral-500 text-[11px] font-mono"
          role="status"
        >
      ...
      <div>
        <h2
          id="skills-title"
          className="font-raleway text-neutral-700 dark:text-neutral-200 font-bold text-xl md:text-2xl mb-2"
          itemProp="name"
        >
          {t.heading}
        </h2>
        <p
          className="font-raleway text-neutral-500 dark:text-neutral-400 text-sm"
