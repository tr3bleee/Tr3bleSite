...
function SkillTag({ icon, imageSrc, text }: SkillTagProps) {
  return (
    ...
    >
      <div
        className="p-1.5 rounded-xl bg-neutral-100/80 dark:bg-neutral-800/50"
        aria-hidden="true"
      >
        {icon && typeof icon === "string" && (
          <p className="font-zed-icons text-neutral-600 dark:text-neutral-300 text-[16px]">
            {icon}
          </p>
        )}
        {icon && typeof icon !== "string" && (
      ...
      <span className="font-raleway text-[13px] font-semibold text-neutral-700 dark:text-neutral-200">
        {text}
      </span>
    </div>
  );
...
export default function AboutCard() {
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-xl bg-slate-200/50 dark:bg-neutral-800/90">
            <p
              className="font-zed text-neutral-500 dark:text-neutral-400 text-[13px]"
              role="presentation"
            >
              {t.title}
            </p>
        ...
        >
          ...
          <div
            className="text-neutral-400 dark:text-neutral-500 text-[10px] md:text-[11px] font-mono"
            role="status"
      ...
      <section
        className="grid md:flex gap-5 md:gap-6 items-center"
        role="region"
        aria-labelledby="developer-intro"
      >
        <div className="grid gap-4 md:gap-5 relative">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <h1
              id="developer-intro"
              className="font-onest text-neutral-700 dark:text-neutral-200 font-semibold text-lg md:text-xl lg:text-2xl"
              itemProp="name"
            >
              {t.greeting}{" "}
              <span
                className="gradient-text font-onest"
